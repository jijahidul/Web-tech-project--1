...
<!--For Username-->
			<tr>
				<td><b>Username:</b></td>
				<td>
					<input type="text" value="<?php echo $uname;?>" name="uname" placeholder="Username: min 6 chars">
  ...
  <!--For Email-->
          ...
          <tr>
            <td><b>E-mail</b></td>
            <td colspan="2"><input type="text" name="mail" size="30" placeholder="ex:myname@example.com" value="<?php echo $mail;?>">
  ...
  <!--for Phone-Number -->
          <tr>
            ...
            <!--phone-->
            <td>
              <input type="text" name="phone" value="<?PHP echo $phone;?>" placeholder="ex: 01*********">
  ...
  <!--Address-->
          <tr>
            ...
            <td colspan="2"><!--Street address -->
              <input type="text" name="stadd1" size=45 value="<?PHP echo $stadd1?>" placeholder="Address of your residence">
